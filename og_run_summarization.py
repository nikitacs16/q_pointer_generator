...
tf.app.flags.DEFINE_integer('max_que_steps', 100, 'max timesteps of query encoder (max source query tokens)')
...
tf.app.flags.DEFINE_integer('vocab_size', 25000, 'Size of vocabulary. These will be read from the vocabulary file in order. If the vocabulary file contains fewer words than this number, or if this number is set to 0, will take all words in the vocabulary file.')
