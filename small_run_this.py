import os
os.system('python run_summarization.py --mode=train')
#=True --convert_to_coverage_model=True   --data_path=/storage/home/nikita/finished_files/chunked/train_* --vocab_path=/storage/home/nikita/finished_files/vocab --log_root=/scratch/scratch1/nikita/pg --exp_name=oracle_8k_full_history')
